...
<template>
  <div class="h-full bg-white rounded-xl overflow-hidden shadow-2xl">
    <!-- Browser Chrome -->
    ...
    <div class="h-[calc(100%-44px)] bg-gray-50 p-8">
      ...
      <!-- Skeleton/Partial/Full States -->
      <div v-else class="space-y-4">
        <!-- Simulated App UI -->
        <div class="bg-white rounded-lg shadow-sm p-6">
          <div class="flex items-center justify-between mb-6">
            <div class="h-8 bg-gray-200 rounded w-48 animate-pulse"></div>
            <div class="h-8 bg-gray-100 rounded-lg w-24 animate-pulse"></div>
          </div>
          ...
          <div v-if="previewState.type === 'full'" class="bg-gray-50 rounded-lg p-4">
